...
public class Conversion {    
    ...
    public byte[] toByta(boolean data) {
    ...
    public byte[] toByta(String data) {
    ...
    public short[] toShortA(byte[] data) {
    ...
    public float[] toFloatA(byte[] data) {
        if (data == null || data.length % 4 != 0) return null;
        // ----------
    ...
    public boolean[] toBooleanA(byte[] data) {
    ...
    public String[] toStringA(byte[] data) {
