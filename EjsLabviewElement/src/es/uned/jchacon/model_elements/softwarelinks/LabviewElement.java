package es.uned.jchacon.model_elements.softwarelinks;
...
public class LabviewElement extends AbstractModelElement {
	...
	static ImageIcon ELEMENT_ICON = ResourceLoader.getIcon("es/uned/jchacon/model_elements/softwarelinks/Labview.png"); // This icon is included in this jar
	...
	public String getConstructorName() { return "es.uned.jchacon.model_elements.softwarelinks.Labview"; }// se mantiene HVO
	...
	protected String getHtmlPage() {
		return "es/uned/jchacon/model_elements/softwarelinks/Labview.html";
	}
