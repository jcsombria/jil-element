package cl.pucv.ejs.model_elements.softwarelinks;
...
public class LabviewElement implements ModelElement {
	  ...
	  public void showHelp(Component _parentComponent) {
	    if (mHelpDialog==null) { // create the dialog
	      mHelpDialog = new JDialog((JFrame) null,"Model Element Help For"+" "+ getGenericName());
	  ...
	  public void showEditor(String _name, Component _parentComponent, ModelElementsCollection _collection) {
	    if (mEditorDialog==null) {
	      ...
	      mEditorDialog = new JDialog((JFrame) null,"Model Element Editor For"+ " "+ _name+ " ("+ getGenericName() + ")");
	  ...
	  public void refreshEditor(String _name) {
	    if (mEditorDialog!=null) mEditorDialog.setTitle("ModelElementEditorFor"+ " "+ _name+ " ("+ getGenericName() + ")");
	  }
	...
	static ImageIcon ELEMENT_ICON = ResourceLoader.getIcon("cl/pucv/ejs/model_elements/softwarelinks/Labview.png"); // This icon is included in this jar
	...
	/** 
	 * Added by Jesús Chacón - 27/10/2012
	...
	public ImageIcon getImageIcon() { return ELEMENT_ICON; }// se mantiene HVO
  
	public String getGenericName() { return "Labview"; }// se mantiene HVO
  
	public String getConstructorName() { return "cl.pucv.ejs.model_elements.softwarelinks.Labview"; }// se mantiene HVO
  
	/** 
	 * Modified by Jesús Chacón <jchacon@bec.uned.es> - 13/11/2012
	...
	public String getInitializationCode(String _name) {
		...
		String labviewCode = _name + " = new " + getConstructorName()+ "(\"<labview:" + 
							 ModelElementsUtilities.getPureValue(server) + ":" + 
							 ModelElementsUtilities.getPureValue(port)+">\")" +
							 "{" + setValuesCode + getValuesCode + openVICode + "};";

		//System.out.println(_name + " = new " + getConstructorName()+"(\"<labview:" + ModelElementsUtilities.getPureValue(server) + ":" + ModelElementsUtilities.getPureValue(port)+">\");");
		System.out.println(labviewCode);
	...
	/** 
	 * Modified by Jesús Chacón <jchacon@bec.uned.es> - 27/10/2012
	 * Write the state into an XML String  
	 */
	...
	protected String getHtmlPage() {
		return "cl/pucv/ejs/model_elements/softwarelinks/Labview.html";
	}
...
//		sl_topPanel.putConstraint(SpringLayout.EAST, portLabel, 126, SpringLayout.WEST, serverLabel);
    	...
    	AbstractAction testServer = new AbstractAction("Get VI variables"){
    		...
    		public void actionPerformed(ActionEvent e) {				
    			if(jilTest == null) {    				
    				jilTest = new Labview("<labview:" + serverText.getText() + ":" + portText.getText() +">");
    				jilTest.connect();
    			}
